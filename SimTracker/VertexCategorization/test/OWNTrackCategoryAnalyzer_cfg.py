...
process.add_( 
  cms.Service("TFileService",
      fileName = cms.string("output/OWNTrackCategoryAnalyzerPlayback/OWNTrackHistoryAnalyzer_01_PLAYBACKFIX.root")
  )
)
...
readFiles.extend( [
       ...
       'file:/nfs/dust/cms/user/nowatsd/Rootfiles/ttbar_madgraph_8tev_recodebug/TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola__Summer12_DR53X-PU_S10_START53_V7C-v1__GEN-SIM-RECODEBUG.root'] );
