...
process.vertexCategoryProducer = cms.EDProducer("VertexCategorizerProducer",
    process.vertexCategorizer
)

process.vertexCategoryProducer.vertexProducer = cms.untracked.InputTag('inclusiveCandidateSecondaryVertices')

#process.vertexCategoryProducer.vertexProducer = 'vertexSelector'

process.GlobalTag.globaltag = 'MCRUN2_72_V3::All'

process.p = cms.Path(process.inclusiveCandidateVertexing * process.vertexCategoryProducer) #process.svTagInfoProxy * process.vertexSelector *
...
process.out = cms.OutputModule("PoolOutputModule",
  fileName = cms.untracked.string('vertexCategoryProducer_test.root')
...
process.out.outputCommands.extend(cms.untracked.vstring(
    ...
    'keep *_vertexCategoryProducer_*_*',
    'keep *_*_MergedTrackTruth_*',
    'drop *_softPFElectronsTagInfos_*_*',
    'drop *_softPFMuonsTagInfos_*_*'
    ))
