...
// VertexCategorizer const & VertexCategorizer::evaluate (TrackingVertexRef const & vertex)
// {
//     // Initializing the category vector
//     reset();
// 
...
// void VertexCategorizer::simulationInformation()
// {
...
int VertexCategorizer::vertexInformationClust()
{
