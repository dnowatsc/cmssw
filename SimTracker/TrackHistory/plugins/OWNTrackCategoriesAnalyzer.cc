/*
 *  TrackCategoriesAnalyzer.C ==> OWN MOD
 *
...
class OWNTrackCategoriesAnalyzer : public edm::EDAnalyzer
{
public:

    explicit OWNTrackCategoriesAnalyzer(const edm::ParameterSet&);
    ~OWNTrackCategoriesAnalyzer();
...
OWNTrackCategoriesAnalyzer::OWNTrackCategoriesAnalyzer(const edm::ParameterSet& config) : classifier_(config)
{
    ...
    TFileDirectory directory = fs->mkdir( "OWNTrackCategoriesAnalyzer" );
...
OWNTrackCategoriesAnalyzer::~OWNTrackCategoriesAnalyzer() { }


void OWNTrackCategoriesAnalyzer::analyze(const edm::Event& event, const edm::EventSetup& setup)
{
    // Track collection
...
DEFINE_FWK_MODULE(OWNTrackCategoriesAnalyzer);
