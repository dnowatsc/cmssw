...
process.svcollectorDef = cms.EDFilter("SecondaryVertexCollector",
	MaxCount = cms.int32(__MAX_EVENTS__), #__MAX_EVENTS__
	VertexInput = cms.InputTag("inclusiveMergedVertices"),
	GenParticleInput = cms.InputTag("genParticles")
)


process.svmapEdit = cms.Path(process.inclusiveVertexingEdit * process.svcollectorEdit)
...
process.outEdit = cms.OutputModule("PoolOutputModule",
	fileName = cms.untracked.string('secondary_vertex_map_7_Edit_minHits6MLIP2minpt06vminang07.root'),
	SelectEvents = cms.untracked.PSet(
		SelectEvents = cms.vstring("svmapEdit"))
)
